        ...
        >
          ...
          <div className="relative z-10 flex flex-col justify-center h-full">
            <form onSubmit={handleSubmit} className="grid gap-2">
              ...
              <span className="text-sm text-white/40 text-center">or use your account</span>
              ...
              <Link href="#" className="font-light text-sm text-white/40 hover:text-[#c8ff00] transition-colors">
        ...
        <div className="hidden lg:block w-1/2 h-full overflow-hidden relative">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-[#0a0a0a] to-transparent z-20">
            ...
            <h2 className="text-2xl font-black uppercase tracking-wider text-white/80">
              Master <span className="text-[#c8ff00]">Machine Learning</span>
            </h2>
            <p className="text-sm text-white/40 mt-2">
              Interactive lessons, real understanding, interview readiness.
            </p>
          </div>
        </div>
      </div>
